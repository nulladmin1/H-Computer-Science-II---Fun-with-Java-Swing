...
public class Skyline extends JPanel {
  ...
  final Color CLOUD = new Color(243, 238, 225);
  ...
  public void paintComponent(Graphics g) {
    ...
    g.fillOval(100, 70, 150, 100);
    g.fillOval(150, 50, 200, 100);

    g.fillOval(400, 50, 200, 100);
    g.fillOval(500, 80, 150, 100);
    g.fillOval(550, 50, 80, 100);
    ...
    for (int i = 2; i <= 10; i++) {
      ...
      if (window) {
        g.fillRect(150, centerY - 300 + (60 * i), 100, 50);
      }
      window = !window;
    }
    ...
    for (int i = 2; i <= 30; i++) {
      ...
      if (window) {
        g.fillRect(620, centerY - 400 + (30 * i), 60, 30);
      }
      window = !window;
    }
    ...
    for (int i = 2; i <= 25; i++) {
      ...
      if (window) {
        g.fillRect(760, centerY - 200 + (30 * i), 80, 20);
      }
      window = !window;
    }
